  ...
  async function loadDashboard() {
    ...
    while (true) {
      const result = await supabase
        .from("attendance")
        .select(
          "id, worker_id, attendance_date, attendance_status, notes, created_at"
        )
        .range(
          from,
          from + pageSize - 1
     ...
     * =================================================
     *
     * نستخدم دالة Supabase التي تم إنشاؤها
     * والتي أثبتنا أنها ترجع 12.
     */
    const {
      data: rpcPresent,
      error: rpcError,
